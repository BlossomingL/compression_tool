...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, keep, embedding_size=512):
        ...
        # ks = 7
        self.fc1 = nn.Conv2d(keep[-1], embedding_size, kernel_size=(9, 8), bias=False)
        self.ft1 = Flatten()
...
if __name__ == '__main__':
    model = fresnet100_v3()
    model.load_state_dict(torch.load('/home/linx/program/z-prunning/compression_tool/work_space/pruned_model/model_resnet_100_ljt.pt'))
