...
def pruned_fresnet50_v3(**kwargs):
    ...
    """
    keep_dict = {'101M': [58, 20, 39, 20, 39, 52, 39, 77, 116, 103, 116, 64, 116,
                          39, 116, 231, 231, 205, 231, 231, 231, 128, 231, 103, 231,
                          128, 231, 128, 231, 154, 231, 103, 231, 77, 231, 77, 231,
                          77, 231, 103, 231, 103, 231, 461, 461, 154, 461, 154, 461],
                 '130M': [58, 32, 58, 32, 58, 58, 58, 103, 116, 116, 116, 116, 116,
                            52, 116, 231, 231, 231, 231, 231, 231, 231, 231, 231, 231,
                            231, 231, 231, 231, 180, 231, 180, 231, 128, 231, 128, 231,
                            180, 231, 180, 231, 205, 231, 461, 461, 461, 461, 205, 461]
                 }

    model = ResNet(BasicBlock_v3, [3, 4, 14, 3], keep_dict['130M'], **kwargs)
...
if __name__ == '__main__':
    model = pruned_fresnet50_v3()
    state_dict = torch.load('/home/yeluyue/lz/program/compression_tool/work_space/pruned_model/model_resnet_50_ljt.pt')
