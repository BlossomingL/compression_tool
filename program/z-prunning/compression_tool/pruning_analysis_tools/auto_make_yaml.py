...
def main():
    ...
    config_yaml('/home/linx/program/z-prunning/compression_tool/work_space/sensitivity_data/sensitivity_resnet50_imagenet_2020-09-02-12-37.csv', 0.9630, mode='conv2', img_size=(112, 112))    # config_yaml('../work_space/sensitivity_data/mobilefacenet_y2_zkx_0.7889/fpgm/sensitivity_mobilefacenet_y2_2019-11-05-06-30.csv', 0.721, mode='mobilefacenet_y2', img_size=(112, 112))
